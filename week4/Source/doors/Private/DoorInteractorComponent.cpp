...
static TAutoConsoleVariable<bool> CVarToggleDebugDoor(
	TEXT("Abstraction.DoorInteractorComponent.Debug"),
	false,
	TEXT("Toggle DoorInteractorComponent debug display."),
	ECVF_Default);
...
UDoorInteractorComponent::UDoorInteractorComponent()
{
	...
	CVarToggleDebugDoor.AsVariable()->SetOnChangedCallback(FConsoleVariableDelegate::CreateStatic(&UDoorInteractorComponent::OnDebugToggled));
...
void UDoorInteractorComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UDoorInteractorComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UDoorInteractorComponent::OnDoorOpen()
{
...
void UDoorInteractorComponent::OnDebugToggled(IConsoleVariable* Var)
{
	UE_LOG(LogTemp, Warning, TEXT("OnDebugToggled"));
	
}

void UDoorInteractorComponent::DebugDraw()
{
